...
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (1, 'ELET-001', 'Smartphone Samsung S24', 4500.00, 45, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (2, 'ELET-002', 'Notebook Dell Inspiron', 3200.00, 23, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (3, 'ELET-003', 'Monitor LG Ultrawide', 1200.00, 15, 1) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (4, 'ELET-004', 'Mouse Logitech MX', 350.00, 120, 1) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 2: Livros e Educação
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (5, 'BOOK-001', 'Código Limpo', 90.00, 85, 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (6, 'BOOK-002', 'Arquitetura Limpa', 85.00, 60, 2) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (7, 'BOOK-003', 'Domain Driven Design', 120.00, 40, 2) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 3: Casa e Cozinha
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (8, 'CASA-001', 'AirFryer Mondial', 400.00, 75, 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (9, 'CASA-002', 'Cafeteira Nespresso', 600.00, 30, 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (10, 'CASA-003', 'Robô Aspirador', 1500.00, 12, 3) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (11, 'CASA-004', 'Jogo de Panelas', 250.00, 28, 3) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 4: Moda e Acessórios
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (12, 'MODA-001', 'Camiseta Básica Preta', 49.90, 200, 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (13, 'MODA-002', 'Tênis Nike Revolution', 399.00, 55, 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (14, 'MODA-003', 'Calça Jeans Levis', 250.00, 80, 4) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 5: Esportes e Lazer
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (15, 'SPORT-001', 'Bola de Futebol', 80.00, 100, 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (16, 'SPORT-002', 'Raquete de Tênis', 450.00, 18, 5) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (17, 'SPORT-003', 'Halteres 5kg', 120.00, 42, 5) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 6: Beleza e Perfumaria
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (18, 'BELE-001', 'Perfume Chanel', 800.00, 25, 6) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (19, 'BELE-002', 'Kit Skincare', 150.00, 90, 6) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (20, 'BELE-003', 'Secador de Cabelo', 220.00, 35, 6) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 7: Games e Consoles
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (21, 'GAME-001', 'PlayStation 5', 3800.00, 10, 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (22, 'GAME-002', 'Nintendo Switch', 2100.00, 22, 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (23, 'GAME-003', 'Jogo Zelda', 300.00, 150, 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (24, 'GAME-004', 'Controle Xbox', 450.00, 65, 7) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (25, 'GAME-005', 'Cadeira Gamer', 1200.00, 8, 7) ON CONFLICT (id) DO NOTHING;

-- Produtos Categoria 8: Alimentos e Bebidas
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (26, 'FOOD-001', 'Chocolate Importado', 25.00, 300, 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (27, 'FOOD-002', 'Café Gourmet', 40.00, 110, 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (28, 'FOOD-003', 'Azeite de Oliva', 35.00, 48, 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (29, 'FOOD-004', 'Vinho Tinto', 80.00, 56, 8) ON CONFLICT (id) DO NOTHING;
INSERT INTO tb_products (id, barcode, name, price, stock, category_id) VALUES (30, 'FOOD-005', 'Whey Protein', 150.00, 95, 8) ON CONFLICT (id) DO NOTHING;
